//A Simple Calculator Microservice that can only do addition, substracion, multiplication and division
use actix_web::{get, web, App, HttpResponse, HttpServer, Responder};

#[get("/")]
async fn index() -> impl Responder {
    HttpResponse::Ok().body("This is a simple calculator microservice, please type: /add or subtract or divide or multiply/{a}/{b}")
}
